...
<meta charset="UTF-8">
	...
	<body>
	    ...
	    <div class="search-bar">
                ...
                <div class="swiper-container1">
                    <div class="swiper-wrapper">
	                    <div class="swiper-slide special-slide">
						        <img src="image/popup/battle1.png">  
						</div>
	                    <div class="swiper-slide special-slide">
	                        	<img src="image/popup/battle2.png">  
	                    </div>
	                    <div class="swiper-slide special-slide">
	                    	<a href="PopupDetail4">
	                        	<img src="image/popup/battle3.png">
	                        </a>     
	                    </div>
	                    <div class="swiper-slide special-slide">
	                        <img src="image/popup/battle4.png">
	                    </div>
            ...
            <br/>
            <h5 class="card-title" style="color: white; font-size: 24px;">&nbsp;&nbsp;&nbsp;배틀그라운드 팝업스토어 PUBG 성수</h5>
		    <br/>
		    ...
		    <p style="font-size: 20px;">&nbsp;&nbsp;&nbsp; #게임 &nbsp; #체험 &nbsp; #굿즈 &nbsp; #사전예약</p>
