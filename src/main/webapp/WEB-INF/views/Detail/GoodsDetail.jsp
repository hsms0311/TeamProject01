...
<body>
    ...
    <div class="container">
        <div class="image-section">
            ...
            <img id="main-image" src="image/Goods/goods8.jpg" alt="Product Image" style="border-radius: 15px;">
       ...
       <div class="bg-dark text-white" style="width: 50%; margin: 0 auto; border-radius: 15px;">
        <div class="details-section">
            <h1>카카오 캐릭터 굿즈</h1>
            <div class="price">
                <span class="old-price">28,800원</span>
                <span>22,999원</span>
            </div>
            ...
            <div class="buttons">
                <button class="btn btn cart-btn">장바구니 담기</button>
                <button class="btn btn-primary order-btn">바로구매</button>
            </div>
            <div class="shipping-info">
                <h5>상품설명</h5><br><br/>
                <p>카카오에서 나온 귀여운 그립톡입니다~~~!!!!</p>
            </div>
        </div>
        </div>
        <br/>
