...
<meta charset="UTF-8">
	...
	<body>
	    ...
	    <div class="search-bar">
                ...
                <div class="swiper-container1">
                    <div class="swiper-wrapper">
	                    <div class="swiper-slide special-slide">
						        <img src="/image/Popup/copost3.jpg">   
						</div>
	                    <div class="swiper-slide special-slide">
	                        	<img src="/image/Popup/co3.jpg">    
	                    </div>
	                    <div class="swiper-slide special-slide">
	                    	<a href="PopupDetail4">
	                        	<img src="/image/Popup/co.jpg">
	                        </a>     
	                    </div>
	                    <div class="swiper-slide special-slide">
	                        <img src="/image/Popup/co2.jpg">
	                    </div>
            ...
            <br/>
            <h5 class="card-title" style="color: white; font-size: 24px;">&nbsp;&nbsp;&nbsp;명탐정 코난: 100만 달러의 펜타그램 BIAF 팝업스토어</h5>
		    <br/>
		    <p class="card-text" style="font-size: 20px;">&nbsp;&nbsp;&nbsp;24.04.26 - 24.08.03</p>
		    <p class="card-text" style="font-size: 20px;">&nbsp;&nbsp;&nbsp;서울특별시 종로구 세종대로 175 세종문화회관</p>
		    <p style="font-size: 20px;">&nbsp;&nbsp;&nbsp;#애니 &nbsp; #음식 &nbsp; #게임 &nbsp; #스포츠</p> 
