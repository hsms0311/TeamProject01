...
<html lang="ko">
	...
	<body>
	    <div class="container table-container">
	        <h1 class="text-center">리뷰 게시판</h1>
	            ...
	            <tbody>
	                <c:forEach var="post" items="${boardList}">
	                    <tr align="center">
	                        ...
	                        <td>
	                            <a href="<c:url value='/Member/review/reviewView' />?reviewNum=${post.reviewNum}">
	                                ${post.reviewTitle}
	                                <c:choose>
			...
			<div class="pagination-container text-center">            
	            ...
	            <div class="write-button">
	                <button type="button" class="btn btn-primary" onclick="location.href='/Member/review/reviewWrite';">글쓰기</button>
	            </div>
	        </div>
	    </div>
	
	    <!-- 검색 폼 페이지 하단에 배치 -->
	    <form method="get" action="/Member/review/reviewList" class="search-form">
