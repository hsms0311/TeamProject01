    ...
    <head>
        ...
        <script>
	        function validateForm() {
	            ...
	            alert("그 동안 이용해주셔서 감사합니다 회원탈퇴 되었습니다!");
	            return true;
	        }
    ...
    <body>
        <header class="header d-flex justify-content-between align-items-center p-3 bg-dark text-white">
            <h2 style="margin-right: 50px;">
	        	<a href="/Member/LoginMain" style="color: #fff; text-decoration: none;">PoPupStore</a>
	    	</h2>
            <nav class="nav">
                <a href="#">소개</a>
                <a href="#">팝업스토어</a>
            ...
            <div class="auth">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/EditPage">정보수정</a></li>
                        <li><a class="dropdown-item" href="MyPopupList.html">마이팝업리스트</a></li>
                        <li><a class="dropdown-item" href="Cart.html">장바구니</a></li>
                    </ul>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-5">
			<form class="signup-form" id="signup-form" method="post" action="/Member/Withdraw" onsubmit="return validateForm()">
				<input type="hidden" id="userId" name="userId" value="${userId}">
				<div class="mb-3 row">
				    <label for="userId" class="col-sm-3 col-form-label">아이디</label>
				    <div class="col-sm-6">
				        <input type="text" class="form-control" id="userId" name="userId" value="${userId}" readonly style="background-color: #e9ecef; cursor: not-allowed;">
				    </div>
				</div>
        ...
        <footer class="bg-dark text-white">
            <div class="footer-nav">
                <a href="./image/terms.png">이용약관</a>
                <a href="./image/privacy.png">개인정보처리방침</a>
            </div>
