...
<div class="container">
    <div class="form-container">
        ...
        <form name="editFrm" method="post" enctype="multipart/form-data" action="/Admin/promotionEdit" onsubmit="return validateForm(this);">
	       ...
	       <div class="form-group">
            ...
            <div class="form-footer">
                ...
                <button type="button" class="btn btn-secondary btn-custom" onclick="location.href='/Admin/promotionList';">목록 바로가기</button>
            </div>
        </form>
    </div>
</div>
