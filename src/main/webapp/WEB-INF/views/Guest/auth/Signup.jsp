...
<html lang="ko">
    ...
    <body>
        <div class="container mt-5">
            <form class="signup-form" id="signup-form" method="post" action="/register" onsubmit="return validateForm()">
                <!-- 서버에서 전달된 오류 메시지 출력 -->
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-6">
                        <input type="password" class="form-control" id="signup-pwd" name="userPwd" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-6">
                        <input type="password" class="form-control" id="userPwdConfirm" name="userPwdConfirm" required>
